...
public class Poor implements ProxyPool{
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Poor{");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Poor)) return false;
        Poor poor = (Poor) o;
        return Objects.equals(getProxies(), poor.getProxies());
    }
