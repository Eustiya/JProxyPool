 ...
 * @version: $
 */
public class Excellent implements ProxyPool {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Excellent{");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Excellent)) return false;
        Excellent excellent = (Excellent) o;
        return Objects.equals(getProxies(), excellent.getProxies());
    }
